...
class Picture {
    ...
    toString(picture) {
        return `id: ${__classPrivateFieldGet(picture, _Picture_id, "f")}, title: ${__classPrivateFieldGet(picture, _Picture_title, "f")}, orientation: ${__classPrivateFieldGet(picture, _Picture_orientation, "f")}`;
    }
}
